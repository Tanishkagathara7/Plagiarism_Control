...
async function testLiveCompareEndpoint() {
  try {
    console.log('🧪 Testing live compare endpoint...');
    ...
    console.log('🔍 Making compare request to live server...');
    ...
    console.log('✅ Compare endpoint successful on live server!');
